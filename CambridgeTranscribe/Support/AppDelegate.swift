...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let lectures = [LectureDocument(id: "cs106", shortName: "TEST", name: "TEST Transcript", color: .turquoise)]
        ...
        let transcript = TranscriptDocument(id:"test-01", title: "Example Transcript", sequence: 6, fragments: fragments, lectureId: "cs106")
